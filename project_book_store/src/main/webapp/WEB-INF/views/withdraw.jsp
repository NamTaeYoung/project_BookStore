...
<head>
  ...
  <style>
    ...
    .withdraw-box { background-color: white; border-radius: 10px; padding: 40px; box-shadow: 0 0 10px rgba(0,0,0,0.05); max-width: 800px; margin: 0 auto; }
    h2 { margin-bottom: 20px; }
    .notice { background-color: #f8f9fa; border-radius: 8px; padding: 20px; margin-bottom: 30px; border: 1px solid #ddd; }
    .notice strong { color: #d60000; }
    .input-box { background-color: #f8f9fa; padding: 30px; border-radius: 10px; text-align: center; }
    input { width: 250px; padding: 10px; margin: 5px; border: 1px solid #ccc; border-radius: 6px; }
    .withdraw-btn { background-color: #2d6cdf; color: white; border: none; padding: 12px 30px; font-size: 16px; border-radius: 8px; cursor: pointer; margin-top: 10px; }
    .withdraw-btn:hover { background-color: #1d4fc2; }
  </style>
</head>
<body>
  <div class="sidebar">
  ...
  <div class="content">
    <div class="withdraw-box">
      ...
      <div class="input-box">
        <input type="text" placeholder="아이디" value="abcdef" readonly><br>
