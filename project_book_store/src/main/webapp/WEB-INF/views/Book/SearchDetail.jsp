...
<main class="page-wrap">
  <div class="page-container">
    ...
    <nav class="breadcrumb">
      ...
      <a href="<c:url value='/Search'/>">도서 목록</a> > 
      <span><c:out value="${book.book_title}"/></span>
    </nav>

    <!-- Product Detail -->
    <div class="product-detail">
      <div class="product-main">
        <div class="product-image <c:if test='${not empty book.book_image_path}'>has-image</c:if>">
          <c:choose>
            <c:when test="${not empty book.book_image_path}">
              <img src="<c:url value='${book.book_image_path}'/>" alt="<c:out value='${book.book_title}'/>">
            </c:when>
            <c:otherwise>
        ...
        <div class="product-info">
          ...
          <div class="product-description">
            <p>
              <c:out value="${book.book_comm != null ? book.book_comm : '도서 소개 정보가 없습니다.'}"/>
            </p>
          </div>

          <div class="product-actions">
			  <button class="btn" id="btnAddToCart" type="button">🛒 장바구니 담기</button>
			  <button class="btn btn-accent" id="btnBuyNow" type="button">💳 구매하기</button>
		  </div>
  ...
  <div class="book-details-grid">
    <div class="book-detail-item"><span class="detail-label">저자</span><span class="detail-value"><c:out value="${book.book_writer}"/></span></div>
    <div class="book-detail-item"><span class="detail-label">출판사</span><span class="detail-value"><c:out value="${book.book_pub}"/></span></div>
    ...
    <div class="book-detail-item"><span class="detail-label">ISBN</span><span class="detail-value"><c:out value="${book.book_isbn}"/></span></div>
