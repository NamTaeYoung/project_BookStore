...
import com.lgy.project_book_store.service.SocialLoginService;
import com.lgy.project_book_store.service.UserService;
    ...
    public String socialLogin(@PathVariable String provider,
        ...
        if (existing != null) {
            ...
            if (existingType != null && existingType.equalsIgnoreCase(userInfo.getLoginType())) {
                ...
                session.setAttribute("loginName", existing.getUser_name());
