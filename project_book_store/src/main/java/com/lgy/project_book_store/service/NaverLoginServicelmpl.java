...
public class NaverLoginServicelmpl implements SocialLoginService {
    ...
    private final String clientId = "M9W3QAsKHIjJb2oLN0G5";
    private final String clientSecret = "pylzhNXTCV";
    private final String redirectUri = "http://localhost:8181/project_book_store/oauth/naver";
